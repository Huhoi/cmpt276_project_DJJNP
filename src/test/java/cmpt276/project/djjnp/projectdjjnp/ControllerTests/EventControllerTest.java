...
public class EventControllerTest {
    ...
    public void testGetEventsByUid() throws Exception{
        ...
        List<Event> allList = Arrays.asList(correctEventOne, correctEventTwo, correctEventThree, wrongEventOne, wrongEventTwo);
    ...
    public void testCalendarAdd() throws Exception{
        ...
        given(controller.saveEvent(Mockito.any(Event.class))).willReturn(ResponseEntity.status(HttpStatus.CREATED).body(event));
    ...
    public void testDisplayAdd() throws Exception{
        ...
        given(controller.saveMarker(Mockito.any(Event.class))).willReturn(ResponseEntity.status(HttpStatus.CREATED).body(event));
